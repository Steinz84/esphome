...
#define EXIST_MODE "setRunApp 0"
   ...
   * @param trig The trigger distance (unit: cm) ranges from 2.4 to 20m (240 to 2000). The actual configuration range
   * does not exceed the maximum and minimum detection distance.
   * @return true or false
   */
